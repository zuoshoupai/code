...
@section('content')
    <div class="header text-center">
        ...
        <p class="description text-muted">{{ Setting()->get('register_title','欢迎加入酷巴酷网络问答社区') }}</p>
    </div>

    @if(isset($success))
    <div class="col-md-4 col-md-offset-4 bg-white login-wrap" id="success">
    ...
    @else
        <div class="col-md-4 col-md-offset-4 bg-white login-wrap">
